		...
		<div class="container">
			<div class="navbar-header">
				<button type="button" data-toggle="collapse"
					...
					<span class="sr-only">Barra de Administración</span> <span
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
                                    <li <?php if($uri == 'index.html') echo "class='active'"; ?>><a href="index.html">Inicio</a></li>
					<li <?php if($uri == 'homeAdmin.php') echo "class='active'"; ?>><a href="homeAdmin.php">Menú Admin</a></li>
